...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  py::class_<ModuleMeta, std::shared_ptr<ModuleMeta>>(m, "ModuleMeta")
    ...
    .def_readwrite("num_encoder_moe_layer",        &ModuleMeta::num_encoder_moe_layer)
    .def_readwrite("num_decoder_moe_layer",        &ModuleMeta::num_decoder_moe_layer)
    ...
    .def_readwrite("erpp_encoder_budgets",         &ModuleMeta::erpp_encoder_budgets)
    .def_readwrite("erpp_encoder_layers",          &ModuleMeta::erpp_encoder_layers)
    .def_readwrite("enable_erpp_encoder_jit_refill", &ModuleMeta::enable_erpp_encoder_jit_refill)
    .def_readwrite("erpp_encoder_jit_refill_window", &ModuleMeta::erpp_encoder_jit_refill_window)
    .def_readwrite("erpp_encoder_jit_refill_floor_mode", &ModuleMeta::erpp_encoder_jit_refill_floor_mode)
    .def_readwrite("erpp_encoder_jit_refill_floor_value", &ModuleMeta::erpp_encoder_jit_refill_floor_value)
    .def_readwrite("erpp_encoder_jit_refill_low_watermark_ratio", &ModuleMeta::erpp_encoder_jit_refill_low_watermark_ratio)
    .def_readwrite("erpp_encoder_jit_refill_layers", &ModuleMeta::erpp_encoder_jit_refill_layers)
    .def_readwrite("erpp_encoder_jit_refill_per_idle", &ModuleMeta::erpp_encoder_jit_refill_per_idle)
    .def_readwrite("enable_erpp_encoder_jit_topk_cover", &ModuleMeta::enable_erpp_encoder_jit_topk_cover)
  ...
  py::class_<PrefetchMngr, std::shared_ptr<PrefetchMngr>>(m, "PrefetchMngr")
    ...
    .def("report_erpp_encoder_layer0", &PrefetchMngr::report_erpp_encoder_layer0)
