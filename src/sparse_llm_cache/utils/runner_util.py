...
def prepare_argparser(parser = None):
  ...
  parser.add_argument("--initial_cache_policy",           type=str, choices=["manual", "hot_expert", "hot_encoder_coverage", "hot_encoder_balanced_coverage", "hot_encoder_l0_priority_coverage"])
