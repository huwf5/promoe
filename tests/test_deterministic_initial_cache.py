...
def test_resolve_initial_cache_inputs_accepts_hot_encoder_prefix_coverage():
  hot = _resolve_initial_cache_inputs("hot_encoder_prefix_coverage", None, "/tmp/hot.json", None)
